...
2006年，Kristian Gjøsteen公开了其报告，称“Dual_EC_DRBG is not cryptographically sound”，并构造了一个具有0.0011优势 bit-predictor，证明了其不满足 CSPRNG的随机数发生器设计原理。
...
2013年，Edward Snowden泄露的内部备忘录曝光了 NSA's Bullrun 项目，显示该项目在 Dual_EC_DRBG 中植入了一个后门。

美国EMC公司的RSA事业本部于2013年9月19日宣布，该公司已向其加密工具“RSA BSAFE”及“RSA Data Protection Manager”的客户发出呼吁，不要使用其默认的 Dual_EC_DRBG 技术标准，RSA目前正在审查其所有的产品。
